...
public class ReservationService {
    ...
    static Reservation getNewReservation(Customer customer, IRoom room, Date checkIn, Date checkOut){
    ...
    public Reservation reserveARoom(Customer customer, IRoom room, Date checkIn, Date checkOut){
        reservations.add(getNewReservation(customer, room, checkIn, checkOut));
        return getNewReservation(customer, room, checkIn, checkOut);
    }
