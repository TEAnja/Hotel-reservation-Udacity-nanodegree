...
public class MainMenu {
    ...
    private static void findAndReserveARoom() {
        ...
        if (customer != null){ ;
            ...
            while(checkOut == null) {
                ...
                if(parseDate(checkOutDate) == null){
                    System.out.println("Please enter a valid date format (dd/mm/yyyy).");
                }else{
            ...
            if(HotelResource.findARoom(checkIn, checkOut) == null) {
    ...
    public static Date parseDate(String stringToDate){
        try{
            Date date = new SimpleDateFormat("mm/dd/yyyy").parse(stringToDate);
            return date;
